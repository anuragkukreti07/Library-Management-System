...
<body style="font-family: 'Source Code Pro', monospace; font-weight: 400;">
    ...
    <main style="display:flex;align-items:center;padding-top:100px;">
        <div
            style="width:50vh;max-width: 600px;margin: 0 auto;padding: 50px;box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
            <h2>Sign Up</h2>
            <div>
                <?php
            ...
            <form action="signup.php" method="post">
                ...
                <div>
                    <br>
                    <p style="text-align: center;">Already Registered <a style="text-decoration:underline;"
